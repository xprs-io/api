...
{
    /// <summary>
    ///     A generic repository for CRUD operations on data sources that do no
    ///     require any special handling for update operations.
    /// </summary>
    ...
    public interface IRepository<in TPrimaryKey, TEntity> : IQueryableRepository<TEntity>
    {
        ...
        /// </param>
        /// <returns>
        ///     Returns a new instance of a <typeparamref name="TEntity" /> that
        ///     will automatically be tracked for changes.
        /// </returns>
        TEntity Load([NotNull] TPrimaryKey key);

        /// <summary>
        ///     <see cref="Store" /> an instance of
        ///     <typeparamref name="TEntity" /> in the data source.
        /// </summary>
        /// <param name="entity">The entity to store.</param>
        void Store([NotNull] TEntity entity);

        /// <summary>
        ///     Remove an instance of <typeparamref name="TEntity" /> from the
        ///     data source.
        /// </summary>
        ...
        /// <summary>
        ///     Remove an instance of <typeparamref name="TEntity" /> from the
        ///     data source based on its primary key.
        /// </summary>
        /// <param name="key">
        ///     A unique identifier that represents the entity in the remote data
        ///     source
